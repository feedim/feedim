...
export async function generateMetaKeywordsAI(
  ...
  try {
    ...
    logServerError('[SEO] Haiku keyword selection failed', err, {
      operation: 'select_keyword_haiku',
    });
  }
...
export async function generateSeoFieldsAI(
  ...
  try {
    ...
    logServerError('[SEO] AI SEO generation failed', err, {
      operation: 'generate_seo_ai',
    });
  }
