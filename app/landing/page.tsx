      ...
      <div className="flex-1 lg:min-h-0 flex flex-col lg:flex-row">
        ...
        <div className="flex-1 lg:flex-none lg:w-[440px] xl:w-[480px] shrink-0 flex flex-col px-6 py-8 sm:p-10 lg:py-6 lg:border-l border-border-primary">
          <div className="w-full sm:max-w-[400px] sm:mx-auto lg:max-w-none lg:mx-0 my-auto">
            ...
            <h1 className="text-[1.3rem] sm:text-[1.5rem] lg:text-[1.5rem] font-extrabold leading-[1.15] mb-1.5">
              {t("title")}
            </h1>
            ...
            {mounted && hasSavedAccounts && (
              <>
                ...
                <LandingGoogleButton label={t("googleContinue")} onClick={handleOAuth} />
                ...
                <p className="text-[0.73rem] text-text-muted mt-2 leading-relaxed">
                  {t("termsAgreePrefix")}{" "}
                  <NewTabLink href="/help/terms" className="text-accent-main hover:underline">{t("termsLink")}</NewTabLink>
                  {" "}{t("termsAgreeAnd")}{" "}
                  <NewTabLink href="/help/privacy" className="text-accent-main hover:underline">{t("privacyLink")}</NewTabLink>
                  {" "}{t("termsAgreeSuffix")}
                </p>
              </>
            )}
