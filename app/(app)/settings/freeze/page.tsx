...
export default function FreezeAccountPage() {
  ...
  const [freezeLimitReached, setFreezeLimitReached] = useState(false);
      ...
      onYes: async () => {
        ...
        try {
          ...
          if (res.ok) {
            ...
            if (res.status === 429) {
              setFreezeLimitReached(true);
              setTimeout(() => setFreezeLimitReached(false), 60_000);
            }
          }
        } catch {
      ...
      <div className="py-4 px-4 sm:px-5 max-w-xl mx-auto">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={!selectedReason || freezing || freezeLimitReached}
            className="t-btn accept w-full disabled:opacity-50 disabled:cursor-not-allowed"
