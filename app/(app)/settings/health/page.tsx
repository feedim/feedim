          ...
          <>
            ...
            <div className="bg-bg-secondary rounded-[15px] p-5">
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <NewTabLink href="/help/profile-score" className="text-[0.72rem] text-accent-main hover:underline mt-2 inline-block">
                  {t("healthLearnMore")} &rarr;
                </NewTabLink>
              </div>
              <div className="flex items-center justify-center gap-3 mt-4 pt-3 border-t border-border-primary flex-wrap">
                ...
                <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-error/60" /><span className="text-[0.65rem] text-text-muted">{t("healthLabelSpam")}</span></div>
              </div>
            </div>
