...
export default function InvitePage() {
  ...
  const handleCopy = async () => {
    ...
    const copiedOk = await copyTextToClipboard(profileUrl);
    if (!copiedOk) {
      ...
      <div className="py-4 px-4 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 rounded-[10px] hover:bg-bg-tertiary transition text-left"
          >
          ...
          >
            ...
            <span className="text-[0.88rem] font-medium text-text-muted">{t("other")}</span>
          </button>
        </div>
      </div>
    </AppLayout>
