  ...
  const handleCancel = () => {
    feedimAlert("question", t("cancelConfirm"), {
      ...
      onYes: async () => {
        ...
        try {
          const res = await fetch("/api/premium/subscribe", { method: "DELETE" });
      ...
      <div className="py-2">
        {loading ? (
          <div className="space-y-4 px-4 pt-3">
            <div className="h-[120px] rounded-[16px] bg-bg-secondary animate-pulse" />
          ...
          <>
            ...
            <div className="mt-5">
              ...
              <div className="flex items-center justify-between px-4 py-3.5 rounded-[13px]">
                ...
                <span className="text-sm font-semibold">{Number(subscription.amount_paid).toLocaleString(locale)}₺</span>
              </div>
