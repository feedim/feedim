...
export default function AdminPage() {
  ...
  const PROFILE_APPROVE_KEYS = ['profileApprove_appropriate', 'profileApprove_falsePositive', 'profileApprove_normal'] as const;
  const PROFILE_REJECT_KEYS = ['profileReject_avatar', 'profileReject_username', 'profileReject_bio', 'profileReject_impersonation', 'profileReject_bot', 'profileReject_spam', 'profileReject_multiAccount', 'profileReject_redirect'] as const;
