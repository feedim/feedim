  ...
  if (projects.length === 0) {
    return (
      <div className="h-dvh bg-black flex flex-col items-center justify-center text-white px-6">
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-2">Henuz icerik yok</h2>
        <p className="text-gray-400 text-sm text-center mb-6">Herkese acik paylasilan sayfalar burada gorunecek</p>
