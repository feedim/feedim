    ...
    <AppLayout hideRightSidebar headerTitle="Ses" headerOnBack={() => router.back()}>
      <div className="px-4 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="w-20 h-20 rounded-2xl bg-bg-tertiary flex items-center justify-center shrink-0 overflow-hidden">
            {sound.cover_image_url ? (
              <img src={sound.cover_image_url} alt="" className="w-full h-full object-cover" />
            ) : moments.length > 0 && (moments[0].video_thumbnail || moments[0].featured_image) ? (
              <img src={moments[0].video_thumbnail || moments[0].featured_image} alt="" className="w-full h-full object-cover" />
            ) : (
        ...
        <div className="flex gap-3 mb-6">
          ...
          <Link
            href={`/dashboard/write/moment?sound=${sound.id}`}
