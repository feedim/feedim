...
export const articles: HelpArticle[] = [
  ...
  },
  {
    ...
    answer: <>Evet. <strong>Ayarlar &rarr; Güvenlik</strong> bölümünden e-posta adresinizi güncelleyebilirsiniz. Değişiklik sonrası yeni e-posta adresinize bir doğrulama bağlantısı gönderilir. Doğrulamadan önce eski e-posta adresiniz aktif kalır.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    answer: <>Kopya içerik, platformdaki mevcut bir içerikle %90 ve üzeri metin benzerliği tespit edilen içeriktir. Bu tarama <strong>her zaman aktif</strong>tir ve kapatılamaz &mdash; telif koruması açılmamış olsa bile çalışır. Tespit edilen kopya içerik moderasyona alınır.</>,
  },
  {
    section: "telif",
  ...
  },
  {
    ...
    answer: <>Ayarlar &rarr; Bildirimler bölümünden her bildirim türünü ayrı ayrı açıp kapatabilirsiniz (<Heart className={ico} /> beğeni, <MessageCircle className={ico} /> yorum, takip, Jeton kazanımı vb.). Tüm bildirimleri geçici olarak kapatmak için <strong>&lsquo;24 saat duraklatma&rsquo;</strong> özelliğini kullanabilirsiniz.</>,
  },
  {
    section: "bildirim",
