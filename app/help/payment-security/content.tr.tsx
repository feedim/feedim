...
export default function PaymentSecurityContentTr() {
  return (
    <>
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Kart bilgileriniz yalnızca ödeme anında şifrelenerek doğrudan ödeme altyapı sağlayıcımıza iletilir.</li>
            <li>Ödeme altyapımız PCI-DSS Level 1 sertifikasına sahip, uluslararası güvenlik standartlarına uyumludur.</li>
        ...
        <section>
          ...
          <p>
            ...
            <NewTabLink href="/help/refund-policy" className="text-accent-main hover:underline">İade ve İptal Politikamızı</NewTabLink>{" "}
            inceleyebilirsiniz.
          </p>
        </section>
