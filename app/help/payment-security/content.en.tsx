      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Your card information is encrypted and transmitted directly to our payment provider only at the time of payment.</li>
            <li>Our payment infrastructure holds PCI-DSS Level 1 certification and complies with international security standards.</li>
        ...
        <section>
          ...
          <p>
            ...
            please review our{" "}
            <NewTabLink href="/help/refund-policy" className="text-accent-main hover:underline">Refund and Cancellation Policy</NewTabLink>.
          </p>
        </section>
