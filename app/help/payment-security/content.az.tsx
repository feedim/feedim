      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Kart məlumatlarınız yalnız ödəniş anında şifrələnərək birbaşa ödəniş infrastrukturu təminatçımıza ötürülür.</li>
            <li>Ödəniş infrastrukturumuz PCI-DSS Level 1 sertifikatına sahib, beynəlxalq təhlükəsizlik standartlarına uyğundur.</li>
        ...
        <section>
          ...
          <p>
            ...
            <NewTabLink href="/help/refund-policy" className="text-accent-main hover:underline">Geri Ödəmə və Ləğv Siyasətimizi</NewTabLink>{" "}
