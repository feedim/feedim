    ...
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          ...
          istifadəçilərin müsbət təcrübə yaşamasını təmin etmək üçün müəyyən edilmişdir. Platformu istifadə
          edə bilmək üçün ən azı <strong>15 yaşında</strong> olmalısınız. Bütün istifadəçilər
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Müəllif hüququ nişanı olan məzmunları icazəsiz paylaşmaq qadağandır</li>
        ...
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Şəxsi Məlumat Paylaşımı</h2>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Şikayətiniz əvvəlcə Feedim AI tərəfindən, sonra insan moderasiya komandası tərəfindən diqqətlə nəzərdən keçirilir</li>
        </ul>

        <p className="text-xs text-text-muted mt-6">
          Feedim istifadəçilərin yazı yaradıb, video paylaşa biləcəyi sosial məzmun platformasıdır. Platformada dərc olunan bütün yazılar və məzmunlar müvafiq istifadəçilərin məsuliyyətindədir, Feedim yalnız lazımi tədbirləri görür.
        </p>
        ...
        <p>
          ...
          <NewTabLink href="/help/moderation" className="text-accent-main hover:opacity-80 font-semibold">Moderasiya Sistemi</NewTabLink> səhifəsini
