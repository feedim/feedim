...
export default function CommunityGuidelinesContentTr() {
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          ...
          olumlu bir deneyim yaşamasını sağlamak için belirlenmiştir. Platformu kullanabilmek için en az{" "}
          <strong>15 yaşında</strong> olmanız gerekmektedir. Tüm kullanıcılar bu kurallara uymakla
          yükümlüdür.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Telif hakkı rozeti bulunan içerikleri izinsiz paylaşmak yasaktır</li>
        ...
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Kişisel Bilgi Paylaşımı</h2>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Şikayetiniz önce Feedim AI tarafından, sonra insan moderasyon ekibi tarafından dikkatlice incelenir</li>
        </ul>

        <p className="text-xs text-text-muted mt-6">
          Feedim kullanıcıların gönderi oluşturup, video paylaşabildiği bir sosyal içerik platformudur. Platform üzerinde yayınlanan tüm gönderiler ve içerikler ilgili kullanıcıların sorumluluğundadır, Feedim sadece gerekli önlemleri alır.
        </p>
        ...
        <p>
          ...
          <NewTabLink href="/help/moderation" className="text-accent-main hover:opacity-80 font-semibold">Moderasyon Sistemi</NewTabLink> sayfasını
          inceleyebilirsiniz.
        </p>
