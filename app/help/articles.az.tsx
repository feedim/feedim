...
export const articles: HelpArticle[] = [
  // ─── Hesab və Qeydiyyat ─────────────────────────────────────
  {
    ...
    searchText: "Ana səhifədəki Hesab yarat düyməsinə klikləyin. Ad, soyad, istifadəçi adı, e-poçt və şifrə məlumatlarınızı daxil edin. Google hesabınızla da qeydiyyatdan keçə bilərsiniz. Qeydiyyatdan sonra e-poçtunuza təsdiq kodu göndərilir.",
    answer: <>Ana səhifədəki <strong>&lsquo;Hesab yarat&rsquo;</strong> düyməsinə klikləyin. Ad, soyad, istifadəçi adı, e-poçt və şifrə məlumatlarınızı daxil edin. Google hesabınızla da sürətlə qeydiyyatdan keçə bilərsiniz. Qeydiyyatdan sonra e-poçt ünvanınıza təsdiq kodu göndərilir &mdash; bu kodu daxil edərək hesabınızı aktivləşdirin.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    searchText: "Qeydiyyatdan sonra e-poçt ünvanınıza təsdiq kodu göndərilir. Bu kodu daxil edərək hesabınızı doğrulayın. Doğrulama edilməzsə bəzi xüsusiyyətlər məhdud ola bilər.",
    answer: <>Qeydiyyatdan sonra e-poçt ünvanınıza təsdiq kodu göndərilir. Bu kodu daxil edərək hesabınızı doğrulayın. Doğrulanmamış hesablarda yazı yaratma və bəzi qarşılıqlı əlaqə xüsusiyyətləri məhdud ola bilər. Kod gəlməzsə spam qovluğunuzu yoxlayın. <NewTabLink href="/help/contact" className={lnk}>Dəstək komandamıza</NewTabLink> müraciət edərək kömək ala bilərsiniz.</>,
  },
  {
    section: "hesap",
    question: "E-poçt ünvanımı dəyişə bilərəmmi?",
    searchText: "Parametrlər Təhlükəsizlik bölməsindən e-poçt ünvanınızı yeniləyə bilərsiniz. Yeni ünvanınıza təsdiq kodu göndərilir.",
    answer: <>Bəli. <strong>Parametrlər &rarr; Təhlükəsizlik</strong> bölməsindən e-poçt ünvanınızı yeniləyə bilərsiniz. Dəyişiklikdən sonra yeni e-poçt ünvanınıza təsdiq kodu göndərilir. Doğrulamadan əvvəl köhnə e-poçt ünvanınız aktiv qalır.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    answer: <>Bəli, daxil olmadan ana səhifə və <NewTabLink href="/explore" className={lnk}>kəşf et</NewTabLink> bölməsini gəzə, yazıları oxuya bilərsiniz. Lakin yazı yaratma, bəyənmə, şərh yazma və izləmə kimi qarşılıqlı əlaqələr üçün hesab yaratmalısınız.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    searchText: "Parametrlər Təhlükəsizlik bölməsindən hesabınızı həmişəlik silə bilərsiniz. Bu əməliyyat geri qaytarıla bilməz. Bütün məlumatlarınız 14 gün ərzində silinir.",
    answer: <>Parametrlər &rarr; Təhlükəsizlik bölməsindən hesabınızı həmişəlik silə bilərsiniz. <strong>Bu əməliyyat geri qaytarıla bilməz.</strong> Bütün yazılarınız, şərhləriniz, Jeton balansınız və şəxsi məlumatlarınız 14 gün ərzində həmişəlik silinir. Silmə əməliyyatını təsdiqləmək üçün &lsquo;DELETE&rsquo; yazmalısınız. Daha ətraflı məlumat üçün <NewTabLink href="/help/privacy" className={lnk}>Gizlilik Siyasəti</NewTabLink> səhifəmizə baxın.</>,
  },
  {
    section: "guvenlik",
  ...
  },
  {
    ...
    searchText: "Profil redaktə ekranındakı kamera simgesinə klikləyin, şəkil seçin və kəsmə aləti ilə tənzimləyin. Maksimum 5 MB.",
    answer: "Profil redaktə ekranındakı kamera simgesinə klikləyin, bir şəkil seçin və kəsmə aləti ilə istədiyiniz şəkildə tənzimləyin. Maksimum fayl ölçüsü 5 MB-dır. Şəklinizi istənilən vaxt silə və ya yenisi ilə əvəz edə bilərsiniz.",
  },
  {
    section: "profil",
  ...
  },
  {
    ...
    searchText: "Doğrulanmış hesab nişanı, platformda etibarlılığı sübut edilmiş hesablara verilir. Profil tamamlama, məzmun keyfiyyəti və icma qarşılıqlı əlaqəsi dəyərləndirilir. Premium hesablar da bu nişanı ala bilər.",
    answer: "Doğrulanmış hesab nişanı, platformda etibarlılığı sübut edilmiş hesablara verilir. Nişan avtomatik qiymətləndirmə və komanda təsdiqi ilə verilir. Profil tamamlama faizi, məzmun keyfiyyəti, icma qarşılıqlı əlaqəsi və hesab yaşı kimi meyarlar dəyərləndirilir. Premium üzvlər prioritet olaraq dəyərləndirilir və aktiv Premium hesablar da bu nişanı ala bilər.",
  },
  ...
  // ─── Yazı və Məzmun ──────────────────────────────────────
  {
    ...
    answer: <>Yazı, Feedim-də yaradıb paylaşdığınız məzmundur. Mətn, şəkil, link və zəngin mətn formatlarını dəstəkləyir. Yazılarınız profilinizdə siyahılanır, izləyicilərinizin ana səhifəsində və <NewTabLink href="/explore" className={lnk}>kəşf et</NewTabLink> bölməsində görünür. Hər yazıya etiket əlavə edə, bəyəni və şərh ala bilərsiniz.</>,
  },
  {
    section: "icerik",
  ...
  {
    section: "icerik",
    question: "Not nədir və necə paylaşılır?",
    searchText: "Not qısa və sürətli paylaşımlar üçün istifadə olunan məzmun növüdür. Yarat menyusundan Not seçib mətni yazaraq paylaşa bilərsiniz. Notlar ən çox 280 simvoldur.",
    answer: <>Not qısa düşüncələr və sürətli yeniliklər üçün istifadə olunan məzmun növüdür. Sol menyudakı <strong>&lsquo;Yarat&rsquo;</strong> menyusundan <strong>&lsquo;Not&rsquo;</strong> seçimini açın, mətninizi yazın və paylaşın. Notlar ən çox 280 simvol ola bilər. İstəsəniz etiket əlavə edə, qaralama kimi saxlaya və ya birbaşa dərc edə bilərsiniz.</>,
  },
  {
    section: "icerik",
    question: "Videonu necə yaradıram?",
    searchText: "Yarat menyusundan Video seçin, video faylınızı yükləyin, başlıq və açıqlama əlavə edin. Qaralama saxlaya və ya dərc edə bilərsiniz. Videolar ən çox 10 dəqiqə və 200 MB ola bilər.",
    answer: "Sol menyudakı Yarat menyusundan Video seçin. Əvvəl video faylınızı yükləyin, sonra başlıq, açıqlama, etiket və üz qabığı şəkli kimi sahələri doldurun. Videonu qaralama kimi saxlaya və ya birbaşa dərc edə bilərsiniz. Video müddəti ən çox 10 dəqiqə, fayl ölçüsü ən çox 200 MB olmalıdır.",
  },
  {
    section: "icerik",
    question: "Moment necə paylaşılır?",
    searchText: "Moment qısa video formatıdır. Yarat menyusundan Moment seçin, videonuzu yükləyin, başlıq və etiket əlavə edin. Moment videoları ən çox 60 saniyə və 100 MB ola bilər.",
    answer: "Moment paylaşmaq üçün Yarat menyusundan Moment seçin, videonuzu yükləyin və lazım olan sahələri doldurun. Moment-lərdə başlıq, etiket, görünürlük və şərh ayarlarını edə bilərsiniz. Moment videoları ən çox 60 saniyə və 100 MB ola bilər.",
  },
  {
    section: "icerik",
    question: "Moment-ə səs əlavə edə bilərəmmi?",
    searchText: "Bəli, Moment yaradarkən səs seçicisi ilə səs əlavə edə bilərsiniz. İstəsəniz videonun orijinal səsini də istifadə edə bilərsiniz.",
    answer: "Bəli. Moment yaradarkən səs seçicisi vasitəsilə platformadakı səslərdən birini əlavə edə və ya videonun orijinal səsini istifadə edə bilərsiniz. Səs seçimini dərc etməzdən əvvəl dəyişmək mümkündür.",
  },
  {
    section: "icerik",
    ...
    answer: <>Etiketlər yazınızın mövzusunu və kateqoriyasını müəyyən edir. Yazı yaradarkən ən çox 5 etiket əlavə edə bilərsiniz. Etiketlər yazınızın <NewTabLink href="/explore" className={lnk}>kəşf et</NewTabLink> bölməsində düzgün kateqoriyada görünməsini və digər istifadəçilərin məzmununuzu asanlıqla tapmasını təmin edir. Populyar etiketlər trend siyahısında yer alır.</>,
  },
  {
    section: "icerik",
  ...
  },
  {
    ...
    searchText: "Kopya məzmun başqa bir istifadəçinin məzmunu ilə yüksək dərəcədə mətn oxşarlığı olan məzmundur. Həmişə aktiv olaraq taranır və moderasiyaya alınır.",
    answer: <>Kopya məzmun, platformdakı mövcud bir məzmunla yüksək dərəcədə mətn oxşarlığı aşkar edilən məzmundur. Bu tarama <strong>həmişə aktiv</strong>dir və söndürülə bilməz &mdash; müəllif hüququ qorunması açılmamış olsa belə işləyir. Aşkar edilən kopya məzmun moderasiyaya alınır.</>,
  },
  {
    section: "telif",
    question: "Müəllif hüququ pozuntu sistemi necə işləyir?",
    searchText: "Hər müəllif hüququ və ya kopya pozuntusu üçün hesaba pozuntu qeydi əlavə edilir. Pozuntu sayısı artdıqca profil bal cəzaları başlayır. Təkrarlanan pozuntularda hesab dayandırıla bilər.",
    answer: <>Hər müəllif hüququ və ya kopya məzmun pozuntusu üçün hesabınıza bir pozuntu qeydi əlavə edilir. Pozuntu sayınız artdıqca profil balınız düşür və hesabınıza mərhələli sanksiyalar tətbiq edilir. Təkrarlanan pozuntularda hesabınız həmişəlik dayandırıla bilər. Ətraflı məlumat üçün <NewTabLink href="/help/copyright" className={lnk}>Müəllif Hüququ Qorunması</NewTabLink> səhifəsinə baxın.</>,
  },
  {
    section: "telif",
  ...
  },
  {
    section: "etkilesim",
    question: "Şərh nədir?",
    searchText: "Şərh, bir yazı haqqında düşüncələrinizi paylaşmanızı təmin edir. Şərhlərə cavab verə və @ ilə qeyd edə bilərsiniz.",
    answer: <>Şərh, bir yazı haqqında düşüncələrinizi paylaşmanızı təmin edir. Yazının altındakı <MessageCircle className={ico} /> şərh bölməsindən yaza bilərsiniz. Digər istifadəçiləri @ ilə qeyd edə bilərsiniz. Şərhlərə cavab verilə və <Heart className={ico} /> bəyənilə bilər. Yazı sahibi şərh <Bell className={ico} /> bildirişini alır.</>,
  },
  {
    section: "etkilesim",
  ...
  },
  {
    ...
    answer: <>Saxlama, marağınızı çəkən yazıları əlfəcinlərə əlavə etməyinizi təmin edir. Yazının altındakı <Bookmark className={ico} /> saxla simgesinə klikləyin. Saxladığınız yazılara sol menüdəki <Bookmark className={ico} /> <NewTabLink href="/bookmarks" className={lnk}>Saxlanılanlar</NewTabLink> bölməsindən çata bilərsiniz. Saxlama əməliyyatı gizlidir &mdash; yazı sahibi görə bilmir.</>,
  },
  {
    section: "etkilesim",
    question: "Paylaşma necə edilir?",
    searchText: "Yazının altındakı paylaş düyməsi ilə linki kopyalaya bilər və ya WhatsApp, X, Facebook, Pinterest və e-poçt ilə paylaşa bilərsiniz.",
    answer: <>Yazının altındakı <ShareIcon /> paylaş düyməsinə klikləyin. Linki kopyalaya bilər və ya birbaşa WhatsApp, X (Twitter), Facebook, Pinterest və e-poçt ilə paylaşa bilərsiniz. Mobil cihazda cihazınızın yerli paylaşım menüsü də istifadə edilə bilər.</>,
  },
  {
    section: "etkilesim",
  ...
  // ─── Bildirişlər ────────────────────────────────────────────
  {
    ...
    answer: <><Heart className={ico} /> Bəyəni, <MessageCircle className={ico} /> şərh, cavab, qeyd etmə, izləmə və Jeton qazancı kimi qarşılıqlı əlaqələrdə <Bell className={ico} /> bildiriş alırsınız. Sol menüdəki <Bell className={ico} /> <NewTabLink href="/notifications" className={lnk}>Bildirişlər</NewTabLink> bölməsindən bütün bildirişlərinizi görə bilərsiniz. Oxunmamış bildirişlər mavi nöqtə ilə işarələnir. Hamısını oxunmuş olaraq işarələyə bilərsiniz.</>,
  },
  {
    section: "bildirim",
  ...
  // ─── Jeton və Qazanc ───────────────────────────────────────
  {
    ...
    searchText: "Jeton, Feedim-in virtual valyutasıdır. Premium oxucular məzmunları oxuyub izlədikcə qazanılır, reklam gəlir paylaşımı və hədiyyə sistemi də mövcuddur. Jetonlar nağd pula çevrilə bilər.",
    answer: <>Jeton, Feedim-in virtual valyutasıdır. Premium oxucular məzmunları oxuyub izlədikcə istehsalçılar Jeton qazanır. Bundan əlavə reklam gəlir paylaşımı ilə əlavə qazanc əldə edilir və digər istifadəçilərdən hədiyyə almaq mümkündür. Yığdığınız Jetonları nağd pula çevirə bilərsiniz. Jeton balansınızı profilinizdən və <NewTabLink href="/coins" className={lnk}>Jeton səhifəsindən</NewTabLink> izləyə bilərsiniz.</>,
  },
  {
    section: "jeton",
    question: "Jeton necə qazanıram?",
    searchText: "Premium oxucular yazınızı oxuduqda avtomatik Jeton qazanırsınız. Həmçinin reklam gəlir paylaşımı və digər istifadəçilərdən hədiyyə almaqla da qazanc əldə edirsiniz.",
    answer: "Premium üzvlüyə sahib oxucular yazınızı həqiqətən oxuduqda avtomatik olaraq Jeton qazanırsınız. Həmçinin reklam gəlir paylaşımı ilə əlavə qazanc əldə edə bilər və digər istifadəçilərdən hədiyyə ala bilərsiniz. Sistem premium oxumaları avtomatik olaraq izləyir və qazancınızı hesabınıza əks etdirir.",
  },
  {
    section: "jeton",
    question: "Jeton çıxarışı necə edilir?",
    searchText: "Müəyyən miqdarda Jeton yığdıqda çıxarış sorğusu yarada bilərsiniz. Parametrlər Qazanc bölməsindən bank məlumatlarınızı daxil edin və çıxarış sorğunuzu göndərin.",
    answer: "Müəyyən miqdarda Jeton yığdıqda çıxarış sorğusu yarada bilərsiniz. Parametrlər \u2192 Qazanc bölməsindən bank məlumatlarınızı (IBAN) daxil edin və çıxarış sorğunuzu göndərin. Çıxarış sorğuları iş günlərində emal edilir.",
  },
  {
    section: "jeton",
    ...
    answer: <><NewTabLink href="/coins" className={lnk}>Jeton səhifəsindən</NewTabLink> istədiyiniz paketi seçərək satın ala bilərsiniz. Müxtəlif məbləğlərdə paketlər mövcuddur və bəzilərində bonus Jetonlar var.</>,
  },
  {
    section: "jeton",
  ...
  },
  {
    ...
    searchText: "Super, Pro, Max və Business planları mövcuddur. Hər plan fərqli xüsusiyyətlər təqdim edir.",
    answer: <>Feedim-də dörd Premium plan mövcuddur: <strong>Super</strong>, <strong>Pro</strong>, <strong>Max</strong> və <strong>Business</strong>. Hər plan fərqli imtiyazlar təqdim edir. Pro və yuxarı planlarda Jeton qazanma, analitika və öndə göstərmə kimi əlavə xüsusiyyətlər mövcuddur. Business planı müəssisələr üçün nəzərdə tutulub. Güncel qiymətlər və planları müqayisə etmək üçün <NewTabLink href="/premium" className={lnk}>Premium səhifəsini</NewTabLink> ziyarət edin.</>,
  },
  {
    section: "premium",
  ...
  // ─── Kəşf et və Axtarış ───────────────────────────────────────
  {
    ...
    answer: <><NewTabLink href="/explore" className={lnk}>Kəşf et</NewTabLink> səhifəsi fərqli istifadəçilərin yazılarını kəşf etməyinizi təmin edir. Trend etiketlər, populyar məzmunlar və kateqoriyalara görə yazılar siyahılanır. İzləmədiyiniz istifadəçilərin keyfiyyətli məzmunlarını da burada tapa bilərsiniz.</>,
  },
  {
    section: "kesfet",
  ...
  {
    section: "sorun",
    question: "E-poçt təsdiq kodu gəlmir",
  ...
  },
  {
    ...
    searchText: "Feedim, istifadəçilərin yazı və video paylaşa biləcəyi sosial məzmun platformasıdır. Premium oxucular məzmun oxuduqca istehsalçılar Jeton qazanır. Reklam gəlir paylaşımı və hədiyyə sistemi də mövcuddur.",
    answer: <>Feedim, istifadəçilərin yazı və video paylaşa biləcəyi sosial məzmun platformasıdır. Premium oxucular məzmunları oxuyub izlədikcə istehsalçılar Jeton qazanır. Bundan əlavə reklam gəlir paylaşımı ilə əlavə qazanc əldə edilir və digər istifadəçilərdən hədiyyə almaq mümkündür. Qazanılan Jetonlar nağd pula çevrilə bilər. Ətraflı məlumat üçün <NewTabLink href="/help/about" className={lnk}>Haqqımızda</NewTabLink> səhifəmizə baxın.</>,
  },
  {
    section: "sorun",
