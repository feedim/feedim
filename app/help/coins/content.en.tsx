  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          There are multiple ways to earn tokens on Feedim: having your content genuinely read by Premium subscribers,
          ad revenue sharing, and receiving gifts from other users. The system automatically verifies genuine reads
          and credits your earnings to your account.
        </p>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>You can view package details on the{" "}
              <NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Token Page</NewTabLink>
            </li>
          </ul>
        </div>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3 mt-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>For detailed information, see the{" "}
              <NewTabLink href="/help/payment-security" className="text-accent-main hover:opacity-80 font-semibold">Payment Security</NewTabLink> page
            </li>
          </ul>
        </div>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>You can review detailed balance information, earning history, and purchase history on the{" "}
            <NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Token Page</NewTabLink></li>
        </ul>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>A <strong>minimum token balance</strong> is required for withdrawal</li>
        ...
        <p className="text-xs text-text-muted mt-8">
          For questions about the token system, sign in and use the{" "}
