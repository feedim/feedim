  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          Feedim-də jeton qazanmağın bir neçə yolu var: məzmunlarınızın Premium abunəçilər tərəfindən həqiqətən oxunması,
          reklam gəlir paylaşımı və digər istifadəçilərdən hədiyyə almaq. Sistem, həqiqi oxumaları avtomatik olaraq doğrulayır
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Paket detallarını{" "}
              <NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Jeton Səhifəsi</NewTabLink>ndən
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3 mt-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Ətraflı məlumat üçün{" "}
              <NewTabLink href="/help/payment-security" className="text-accent-main hover:opacity-80 font-semibold">Ödəniş Təhlükəsizliyi</NewTabLink> səhifəsinə
              baxa bilərsiniz
            </li>
          </ul>
        </div>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li><NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Jeton Səhifəsi</NewTabLink>ndən
        ...
        <p>
          Qazandığınız jetonları müəyyən şərtlər daxilində nağd olaraq çəkə bilərsiniz.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Çəkim Şərtləri</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Çəkim üçün <strong>müəyyən jeton balansı</strong> tələb olunur</li>
        ...
        <p>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Nağdlaşdırma &mdash; Qazanılmış jetonları nağd olaraq çəkmə</li>
        ...
        <p className="text-xs text-text-muted mt-8">
          Jeton sistemi haqqında suallarınız üçün hesabınıza daxil olduqdan sonra{" "}
