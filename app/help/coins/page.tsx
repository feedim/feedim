...
export const metadata: Metadata = {
  title: "Jeton ve Bakiye Sistemi - Feedim",
  description: "Feedim jeton ve bakiye sistemi hakkında bilgi. Jeton kazanma, satın alma, çekme, günlük limitler ve kullanım alanları.",
  keywords: ["feedim jeton", "jeton sistemi", "bakiye", "jeton kazanma", "jeton çekme", "jeton satın alma", "feedim coin", "sanal para"],
};
  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <div className="bg-bg-secondary rounded-xl p-4 space-y-3 mt-3">
        ...
        <div className="bg-bg-secondary rounded-xl p-5 mt-8 flex flex-col gap-3">
