  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          Feedim&apos;de jeton kazanmanın birden fazla yolu vardır: içeriklerinizin Premium aboneler tarafından gerçek anlamda okunması,
          reklam gelir paylaşımı ve diğer kullanıcılardan hediye almak. Sistem, gerçek okumaları otomatik olarak doğrular
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Paket detaylarını{" "}
              <NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Jeton Sayfası</NewTabLink>&apos;ndan
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3 mt-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Detaylı bilgi için{" "}
              <NewTabLink href="/help/payment-security" className="text-accent-main hover:opacity-80 font-semibold">Ödeme Güvenliği</NewTabLink> sayfasını
              inceleyebilirsiniz
            </li>
          </ul>
        </div>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li><NewTabLink href="/coins" className="text-accent-main hover:opacity-80 font-semibold">Jeton Sayfası</NewTabLink>&apos;ndan
        ...
        <p>
          Kazandığınız jetonları belirli koşullar dahilinde nakit olarak çekebilirsiniz.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Çekim Koşulları</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Minimum çekim miktarı için <strong>belirli bir jeton bakiyesi</strong> gereklidir</li>
        ...
        <p>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Nakde çevirme &mdash; Kazanılan jetonları nakit olarak çekme</li>
