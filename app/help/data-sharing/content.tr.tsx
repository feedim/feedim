  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          Feedim üzerindeki tüm ödeme işlemleri <strong>güvenli ödeme altyapı sağlayıcımız</strong> aracılığıyla gerçekleştirilir.
          Kredi kartı ve banka kartı bilgileriniz Feedim sunucularında <strong>saklanmaz</strong>. Ödeme bilgileri
          doğrudan ödeme altyapı sağlayıcımız tarafından güvenli bir şekilde işlenir ve saklanır. Feedim yalnızca işlem sonucu
        ...
        <p>
          ...
          detaylı bilgi için{" "}
          <NewTabLink href="/help/privacy" className="text-accent-main hover:opacity-80 font-semibold">Gizlilik Politikası</NewTabLink> sayfamızı
          inceleyebilirsiniz.
        </p>

        <p className="text-xs text-text-muted mt-8">
          Veri paylaşımı hakkında sorularınız varsa hesabınıza giriş yaptıktan sonra{" "}
