  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          Feedim üzərindəki bütün ödəniş əməliyyatları <strong>təhlükəsiz ödəniş infrastrukturu təminatçımız</strong> vasitəsilə həyata keçirilir.
          Kredit kartı və bank kartı məlumatlarınız Feedim serverlərində <strong>saxlanılmır</strong>. Ödəniş məlumatları
          birbaşa ödəniş infrastrukturu təminatçımız tərəfindən təhlükəsiz şəkildə emal edilir və saxlanılır. Feedim yalnız əməliyyat nəticəsini
        ...
        <p>
          Bütün verilən paylaşımları yerli şəxsi məlumatların qorunması qanunvericiliyi və müvafiq qaydalara uyğun olaraq həyata keçirilir.
        </p>
        ...
        <p>
          ...
          <NewTabLink href="/help/privacy" className="text-accent-main hover:opacity-80 font-semibold">Gizlilik Siyasəti</NewTabLink> səhifəmizə
          baxa bilərsiniz.
        </p>

        <p className="text-xs text-text-muted mt-8">
          Verilənlərin paylaşılması haqqında suallarınız üçün hesabınıza daxil olduqdan sonra{" "}
