  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          Feedim-də dörd fərqli məzmun növü ilə özünüzü ifadə edə bilərsiniz: <strong>Yazı (Post)</strong>,{" "}
          <strong>Qeyd</strong>, <strong>Video</strong> və <strong>Moment</strong>. Hər məzmun növü fərqli məqsədlərə xidmət edir və özünəməxsus
        ...
        {/* ── Qeyd ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Qeyd</h2>
        <p>
          Qeyd, qısa və sürətli mətn paylaşımları üçün nəzərdə tutulmuş yüngül bir formatdır.
          Düşüncələrinizi, yeniliklərinizi və ya qısa qeydlərinizi tez paylaşa bilərsiniz.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Qeyd Xüsusiyyətləri</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Maksimum <strong>280 simvol</strong> uzunluğunda qısa mətn</li>
            <li>Sürətli yaratma &mdash; sadə və ani paylaşım</li>
            <li>Örtük şəkli və ya media tələb etmir</li>
          </ul>
        </div>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Maksimum fayl ölçüsü: <strong>200 MB</strong></li>
            <li>Maksimum video müddəti: <strong>10 dəqiqə</strong></li>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Məzmununuz <strong>müntəzəm aralıqlarla</strong> avtomatik olaraq qaralama halında saxlanılır</li>
        ...
        <p>
          ...
          <NewTabLink href="/help/community-guidelines" className="text-accent-main hover:opacity-80 font-semibold">İcma Qaydaları</NewTabLink> və{" "}
          <NewTabLink href="/help/copyright" className="text-accent-main hover:opacity-80 font-semibold">Müəllif Hüququ Qorunması</NewTabLink> səhifələrinə
          baxa bilərsiniz.
        </p>
