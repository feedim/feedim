  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          On Feedim, you can express yourself with four different content types: <strong>Post</strong>,{" "}
          <strong>Note</strong>, <strong>Video</strong>, and <strong>Moment</strong>. Each content type serves different purposes and has
        ...
        {/* ── Note ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Note</h2>
        <p>
          Note is a lightweight format designed for short and quick text shares.
          You can quickly share your thoughts, updates, or brief notes.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Note Features</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Short text up to <strong>280 characters</strong></li>
            <li>Quick creation &mdash; simple and instant sharing</li>
            <li>No cover image or media required</li>
          </ul>
        </div>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Maximum file size: <strong>200 MB</strong></li>
            <li>Maximum video duration: <strong>10 minutes</strong></li>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Your content is automatically saved as a draft at <strong>regular intervals</strong></li>
        ...
        <p>
          ...
          <NewTabLink href="/help/community-guidelines" className="text-accent-main hover:opacity-80 font-semibold">Community Guidelines</NewTabLink> and{" "}
          <NewTabLink href="/help/copyright" className="text-accent-main hover:opacity-80 font-semibold">Copyright Protection</NewTabLink> pages.
        </p>

        <p className="text-xs text-text-muted mt-8">
          For questions about content creation, sign in and use the{" "}
