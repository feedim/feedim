  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          Feedim&apos;de dört farklı içerik türü ile kendinizi ifade edebilirsiniz: <strong>Gönderi (Post)</strong>,{" "}
          <strong>Not</strong>, <strong>Video</strong> ve <strong>Moment</strong>. Her içerik türü farklı amaçlara hizmet eder ve kendine özgü
        ...
        {/* ── Not ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Not</h2>
        <p>
          Not, kısa ve hızlı metin paylaşımları için tasarlanmış hafif bir formattır.
          Düşüncelerinizi, güncellemelerinizi veya kısa notlarınızı hızlıca paylaşabilirsiniz.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Not Özellikleri</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Maksimum <strong>280 karakter</strong> uzunluğunda kısa metin</li>
            <li>Hızlı oluşturma &mdash; basit ve anında paylaşım</li>
            <li>Kapak görseli veya medya gerektirmez</li>
          </ul>
        </div>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Maksimum dosya boyutu: <strong>200 MB</strong></li>
            <li>Maksimum video süresi: <strong>10 dakika</strong></li>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>İçeriğiniz <strong>düzenli aralıklarla</strong> otomatik olarak taslak halinde kaydedilir</li>
        ...
        <p>
          ...
          <NewTabLink href="/help/community-guidelines" className="text-accent-main hover:opacity-80 font-semibold">Topluluk Kuralları</NewTabLink> ve{" "}
          <NewTabLink href="/help/copyright" className="text-accent-main hover:opacity-80 font-semibold">Telif Hakkı Koruması</NewTabLink> sayfalarını
          inceleyebilirsiniz.
        </p>

        <p className="text-xs text-text-muted mt-8">
          İçerik oluşturma ile ilgili sorularınız varsa hesabınıza giriş yaptıktan sonra{" "}
