      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4">
          ...
          <p>
            ...
            <NewTabLink href="/settings/premium" className="text-accent-main hover:opacity-80 font-semibold">Premium page</NewTabLink>.
          </p>
        </div>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Profile Visits</strong> &mdash; How many times your profile has been visited</li>
          </ul>
        </div>

        {/* ── Summary Card ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Summary Card</h2>
        <p>
          Above the metric cards, the summary card presents three key indicators for the selected period in large numbers:
          Reach (total views), Engagement (likes + comments + saves + shares combined), and
          new Followers count. Each indicator is compared with the previous period.
        </p>
        ...
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Premium Reads</strong> &mdash; Number of reads that converted to earnings</li>
          </ul>
        </div>
        ...
        {/* ── Read Duration ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Read Duration</h2>
        <p>
          Read duration measures how much time readers spend on your content.
          This data is displayed both in the analytics panel and in each post&apos;s statistics screen.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">How It Works</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>When a reader opens your post, the system automatically records the reading time and scroll percentage</li>
            <li>The average read duration in the analytics panel shows the average across all your posts in minutes</li>
            <li>In post statistics, the average read duration specific to that post is displayed</li>
          </ul>
        </div>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3 mt-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Premium Reads</p>
          <p>
            Not every view converts into earnings. The system evaluates whether the reader has genuinely
            read the content using signals such as reading time and scroll depth. Only content that is
            read at a sufficient level counts as a premium read and generates token earnings.
          </p>
        </div>
        ...
        <p>
          ...
          These insights are displayed when there is sufficient data (at least 10 views or 5 interactions) and may include:
        </p>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Follower Demographics</h2>
        <p>
          The follower demographics section visually presents the geographic and demographic distribution of your followers.
        </p>
        <div className="bg-bg-secondary rounded-[15px] p-4 space-y-3">
          <p className="font-semibold text-text-primary text-xs uppercase tracking-wide">Demographic Data</p>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Country distribution</strong> &mdash; Which countries your followers come from (with percentages)</li>
            <li><strong>Age ranges</strong> &mdash; Distribution of your followers by age groups</li>
            <li><strong>Gender distribution</strong> &mdash; Gender ratios of your followers</li>
            <li><strong>Active follower ratio</strong> &mdash; Percentage of your followers who have been active recently</li>
          </ul>
        </div>

        <p className="text-xs text-text-muted mt-8">
          For questions about the analytics panel, sign in and use the{" "}
