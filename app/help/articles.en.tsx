...
export const articles: HelpArticle[] = [
  // ─── Account & Registration ─────────────────────────────────
  {
    ...
    searchText: "Click the Create Account button on the home page. Enter your first name, last name, username, email and password. You can also sign up with Google. An OTP code will be sent to your email after registration.",
    answer: <>Click the <strong>&lsquo;Create Account&rsquo;</strong> button on the home page. Enter your first name, last name, username, email and password. You can also quickly sign up with your Google account. After registration, an OTP code will be sent to your email &mdash; enter it to activate your account.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    searchText: "After signing up, an OTP code is sent to your email. Enter this code to verify your account. Some features may be restricted without verification.",
    answer: <>After signing up, an OTP code is sent to your email address. Enter this code to verify your account. Unverified accounts may have limited access to creating posts and some interaction features. If you don&apos;t receive the code, check your spam folder. You can reach out to our <NewTabLink href="/help/contact" className={lnk}>support team</NewTabLink> for help.</>,
  },
  {
    section: "hesap",
    question: "Can I change my email address?",
    searchText: "You can update your email address from Settings Security section. An OTP code will be sent to your new address.",
    answer: <>Yes. You can update your email address from <strong>Settings &rarr; Security</strong>. After the change, an OTP code will be sent to your new email address. Your old email remains active until the new one is verified.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    answer: <>Yes, you can browse the home page and <NewTabLink href="/explore" className={lnk}>explore</NewTabLink> section and read posts without signing in. However, you need to create an account for interactions like creating posts, liking, commenting and following.</>,
  },
  {
    section: "hesap",
  ...
  },
  {
    ...
    answer: <>Feedim has two account types: <strong>Standard</strong> (free) and <strong>Premium</strong>. With a Standard account, you can create posts, comment and interact. Premium accounts offer additional features: ad-free experience, priority support, special badge and more. Check the <NewTabLink href="/premium" className={lnk}>Premium page</NewTabLink> for details.</>,
  },
  ...
  // ─── Privacy & Security ───────────────────────────────────
  {
    ...
    searchText: "Click the Forgot Password link on the login page. Enter your email, and a 6-digit verification code will be sent.",
    answer: <>Click the <strong>&lsquo;Forgot Password&rsquo;</strong> link on the login page. Enter your email address and a 6-digit verification code will be sent to you. Enter the code to set your new password. If you don&apos;t receive the code, check your spam folder.</>,
  },
  {
    section: "guvenlik",
  ...
  },
  {
    ...
    searchText: "You can permanently delete your account from Settings Security. This action cannot be undone. All your data will be deleted within 14 days.",
    answer: <>You can permanently delete your account from Settings &rarr; Security. <strong>This action cannot be undone.</strong> All your posts, comments, Token balance and personal data will be permanently deleted within 14 days. You need to type &lsquo;DELETE&rsquo; to confirm the deletion. For more information, see our <NewTabLink href="/help/privacy" className={lnk}>Privacy Policy</NewTabLink> page.</>,
  },
  {
    section: "guvenlik",
  ...
  },
  {
    ...
    searchText: "Click the camera icon on the profile editing screen, select an image and adjust it with the cropping tool. Maximum 5 MB.",
    answer: "Click the camera icon on the profile editing screen, select an image and adjust it as you like with the cropping tool. Maximum file size is 5 MB. You can remove or replace your photo at any time.",
  },
  {
    section: "profil",
  ...
  },
  {
    ...
    searchText: "The verified account badge is given to accounts whose credibility has been proven on the platform. Profile completion, content quality and community engagement are evaluated. Premium accounts can also receive this badge.",
    answer: "The verified account badge is given to accounts whose credibility has been proven on the platform. The badge is awarded through automatic evaluation and team approval. Criteria such as profile completion rate, content quality, community engagement and account age are evaluated. Premium members are given priority consideration, and active Premium accounts can also receive this badge.",
  },
  ...
  // ─── Posts & Content ──────────────────────────────────────
  {
    ...
    answer: <>A post is content you create and share on Feedim. It supports text, images, links and rich text formats. Your posts are listed on your profile and appear in your followers&apos; home feed and the <NewTabLink href="/explore" className={lnk}>explore</NewTabLink> section. You can add tags to each post and receive likes and comments.</>,
  },
  {
    section: "icerik",
  ...
  {
    section: "icerik",
    question: "What is a note and how do I share it?",
    searchText: "A note is for short, quick posts. Open Note from the Create menu, write your text and publish. Notes can be up to 280 characters.",
    answer: <>A note is a content type designed for short thoughts and quick updates. Open <strong>&lsquo;Note&rsquo;</strong> from the <strong>&lsquo;Create&rsquo;</strong> menu in the left sidebar, write your text and share it. Notes can be up to 280 characters. You can add tags, save as draft, or publish directly.</>,
  },
  {
    section: "icerik",
    question: "How do I create a video?",
    searchText: "Choose Video from the Create menu, upload your video file, and add a title and description. You can save as draft or publish. Videos can be up to 10 minutes and 200 MB.",
    answer: "Choose Video from the Create menu in the left sidebar. First upload your video file, then fill in fields like title, description, tags and cover image. You can save it as draft or publish directly. Video duration can be up to 10 minutes, and file size can be up to 200 MB.",
  },
  {
    section: "icerik",
    question: "How do I share a moment?",
    searchText: "A moment is a short video format. Choose Moment from the Create menu, upload your video and add title and tags. Moments can be up to 60 seconds and 100 MB.",
    answer: "To share a moment, choose Moment from the Create menu, upload your video and complete the required fields. For moments, you can set title, tags, visibility and comment options. Moment videos can be up to 60 seconds and 100 MB.",
  },
  {
    section: "icerik",
    question: "Can I add music to a moment?",
    searchText: "Yes, you can add music with the sound picker while creating a moment. You can also keep your video's original audio.",
    answer: "Yes. While creating a moment, you can add a sound from the sound picker or keep the original audio from your video. You can change the sound selection before publishing.",
  },
  {
    section: "icerik",
    ...
    answer: <>Tags define the topic and category of your post. You can add up to 5 tags when creating a post. Tags help your post appear in the right category in the <NewTabLink href="/explore" className={lnk}>explore</NewTabLink> section and make it easier for other users to find your content. Popular tags appear in the trending list.</>,
  },
  {
    section: "icerik",
  ...
  },
  {
    ...
    answer: <>NSFW (Not Safe For Work) refers to sexual, violent or inappropriate content. Feedim AI automatically detects such content and places it under moderation. A safe environment is maintained across the platform. See the <NewTabLink href="/help/moderation" className={lnk}>Moderation System</NewTabLink> page for details.</>,
  },
  {
    section: "moderasyon",
  ...
  },
  {
    ...
    searchText: "Duplicate content is content with a high level of text similarity to another user's content. It is always actively scanned and placed under moderation.",
    answer: <>Duplicate content is content where a high level of text similarity is detected with existing content on the platform. This scan is <strong>always active</strong> and cannot be turned off &mdash; it works even if copyright protection is not enabled. Detected duplicate content is placed under moderation.</>,
  },
  {
    section: "telif",
    question: "How does the copyright violation system work?",
    searchText: "A violation record is added to the account for each copyright or duplicate violation. As violations increase, profile score penalties begin. Repeated violations may result in account suspension.",
    answer: <>A violation record is added to your account for each copyright or duplicate content violation. As your violation count increases, your profile score decreases and graduated sanctions are applied to your account. Repeated violations may result in your account being permanently suspended. See the <NewTabLink href="/help/copyright" className={lnk}>Copyright Protection</NewTabLink> page for details.</>,
  },
  {
    section: "telif",
  ...
  },
  {
    ...
    searchText: "A comment lets you share your thoughts about a post. You can reply to comments and mention users with @.",
    answer: <>A comment lets you share your thoughts about a post. Write in the <MessageCircle className={ico} /> comment section below the post. You can mention other users with @. Comments can be replied to and <Heart className={ico} /> liked. The post owner receives a comment <Bell className={ico} /> notification.</>,
  },
  {
    section: "etkilesim",
  ...
  },
  {
    ...
    answer: <>Bookmarking lets you save posts that interest you. Click the <Bookmark className={ico} /> bookmark icon below the post. Access your saved posts from the <Bookmark className={ico} /> <NewTabLink href="/bookmarks" className={lnk}>Bookmarks</NewTabLink> section in the left menu. Bookmarking is private &mdash; the post owner cannot see it.</>,
  },
  {
    section: "etkilesim",
    question: "How do I share?",
    searchText: "With the share button below the post, you can copy the link or share via WhatsApp, X, Facebook, Pinterest and email.",
    answer: <>Click the <ShareIcon /> share button below the post. You can copy the link or share directly via WhatsApp, X (Twitter), Facebook, Pinterest and email. On mobile, your device&apos;s native sharing menu is also available.</>,
  },
  {
    section: "etkilesim",
  ...
  // ─── Notifications ────────────────────────────────────────────
  {
    ...
    answer: <>You receive <Bell className={ico} /> notifications for interactions like <Heart className={ico} /> likes, <MessageCircle className={ico} /> comments, replies, mentions, follows and Token earnings. View all your notifications from the <Bell className={ico} /> <NewTabLink href="/notifications" className={lnk}>Notifications</NewTabLink> section in the left menu. Unread notifications are marked with a blue dot. You can mark all as read.</>,
  },
  {
    section: "bildirim",
  ...
  // ─── Tokens & Earnings ───────────────────────────────────────
  {
    ...
    searchText: "Tokens are Feedim's virtual currency. Earned as premium readers read and watch content, plus ad revenue sharing and gifts from other users. Tokens can be converted to cash.",
    answer: <>Tokens are Feedim&apos;s virtual currency. As premium readers read and watch content, creators earn Tokens. Additionally, creators earn through ad revenue sharing and can receive gifts from other users. You can convert your accumulated Tokens to cash. Track your Token balance from your profile and the <NewTabLink href="/coins" className={lnk}>Tokens page</NewTabLink>.</>,
  },
  {
    section: "jeton",
    question: "How do I earn Tokens?",
    searchText: "When Premium readers read your post, you automatically earn Tokens. You also earn through ad revenue sharing and gifts from other users.",
    answer: "When readers with a Premium membership genuinely read your post, you automatically earn Tokens. You can also earn additional income through ad revenue sharing and receive gifts from other users. The system automatically tracks premium reads and reflects the earnings in your account.",
  },
  {
    section: "jeton",
    question: "How do I withdraw Tokens?",
    searchText: "You can create a withdrawal request when you accumulate enough Tokens. Enter your bank details from Settings Earnings and submit your withdrawal request.",
    answer: "You can create a withdrawal request when you accumulate enough Tokens. Enter your bank details (IBAN) from Settings \u2192 Earnings and submit your withdrawal request. Withdrawal requests are processed on business days.",
  },
  {
    section: "jeton",
    ...
    answer: <>You can purchase by selecting your desired package from the <NewTabLink href="/coins" className={lnk}>Tokens page</NewTabLink>. Various packages are available and some include bonus Tokens.</>,
  },
  {
    section: "jeton",
  ...
  // ─── Premium Membership ─────────────────────────────────────
  {
    ...
    answer: <>With Premium membership, you enjoy an ad-free experience, get a verified badge, priority support and unlimited character posts among other perks. You also earn Tokens for content creators whose posts you read. See the <NewTabLink href="/premium" className={lnk}>Premium page</NewTabLink> for details.</>,
  },
  {
    section: "premium",
    question: "What are the Premium plans and pricing?",
    searchText: "Super, Pro, Max and Business plans are available. Each plan offers different features.",
    answer: <>Feedim has four Premium plans: <strong>Super</strong>, <strong>Pro</strong>, <strong>Max</strong> and <strong>Business</strong>. Each plan offers different perks. Pro and above plans include additional features like Token earning, analytics and featured placement. The Business plan is designed for businesses. Visit the <NewTabLink href="/premium" className={lnk}>Premium page</NewTabLink> for current pricing and to compare plans.</>,
  },
  {
    section: "premium",
  ...
  // ─── Explore & Search ───────────────────────────────────────
  {
    ...
    answer: <>The <NewTabLink href="/explore" className={lnk}>Explore</NewTabLink> page lets you discover posts from different users. Posts are listed by trending tags, popular content and categories. You can find quality content from users you don&apos;t follow here.</>,
  },
  {
    section: "kesfet",
  ...
  {
    section: "sorun",
    question: "I'm not receiving the email verification code",
  ...
  },
  {
    ...
    searchText: "Feedim is a social content platform where users can share posts and videos. Premium readers earn Coins for creators. Ad revenue sharing and gift system are also available.",
    answer: <>Feedim is a social content platform where users can share posts and videos. As premium readers read and watch content, creators earn Coins. Additionally, creators earn through ad revenue sharing and can receive gifts from other users. Earned Coins can be converted to cash. See our <NewTabLink href="/help/about" className={lnk}>About Us</NewTabLink> page for details.</>,
  },
  {
    section: "sorun",
