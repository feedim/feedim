  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          Feedim platformunu kullanabilmek için en az <strong>15 yaşında</strong> olmanız gerekmektedir.
          15 yaş altındaki kullanıcılar hesap oluşturamaz ve platformu kullanamazlar. Bu kısıtlama,
        ...
        <p>
          ...
          olarak yapılandırılmıştır. Platform Türkçe, İngilizce ve Azerbaycan Türkçesi olmak üzere üç dilde hizmet vermektedir.
        </p>
        ...
        <p>
          ...
          Gizli hesap sahiplerinin gönderileri, moment'ları ve profil bilgileri takipçi olmayan
        ...
        <p className="text-xs text-text-muted mt-8">
          Erişim kısıtlamaları hakkında sorularınız varsa hesabınıza giriş yaptıktan sonra{" "}
