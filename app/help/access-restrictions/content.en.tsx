  ...
  return (
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <p>
          You must be at least <strong>15 years old</strong> to use the Feedim platform.
          Users under 15 cannot create an account or use the platform. This restriction is applied
        ...
        <p>
          ...
          The platform is available in three languages: Turkish, English, and Azerbaijani.
        </p>
        ...
        <p className="text-xs text-text-muted mt-8">
          For questions about access restrictions, sign in and use the{" "}
