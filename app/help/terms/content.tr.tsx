  ...
  return (
    <>
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        <section>
          <p>
            Feedim, kullanıcıların gönderi yazıp video paylaşabildiği bir sosyal içerik platformudur. Bu koşullar, Feedim platformunu kullanırken
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            <li>Hesap oluşturmak için en az 15 yaşında olmanız gerekmektedir.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Jeton kazanımı, okuma süresi, izlenme süresi ve içerik kalitesine bağlıdır.</li>
