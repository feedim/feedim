...
export default function PreInformationContentTr() {
  return (
    <>
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>
              <strong>Gönderi Öne Çıkarma (Boost):</strong> Kullanıcıların gönderilerini ücretli olarak
              öne çıkarmasını sağlayan reklam hizmetidir. Günlük 100-1.500 TL bütçe ile en fazla 7 gün
              süreyle kampanya oluşturulabilir.
            </li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li><strong>Ödeme altyapısı:</strong> PCI-DSS uyumlu güvenli ödeme altyapısı</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Boost kampanyaları henüz başlamamışsa tam iade yapılabilir. Başlamış veya tamamlanmış kampanyalar için iade yapılmaz.</li>
        ...
        <section>
          ...
          <p>
            ...
            <NewTabLink href="/help/privacy" className="text-accent-main hover:underline">Gizlilik Politikamızı</NewTabLink> ve{" "}
            <NewTabLink href="/kvkk" className="text-accent-main hover:underline">KVKK Aydınlatma Metnimizi</NewTabLink>{" "}
            inceleyebilirsiniz.
          </p>
        </section>
