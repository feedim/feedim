      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li><strong>Payment infrastructure:</strong> PCI-DSS compliant secure payment provider</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Boost campaigns that have not yet started can be fully refunded. Active or completed campaigns are non-refundable.</li>
        ...
        <section>
          ...
          <p>
            Your personal data is processed under applicable personal data protection laws in your country.
            For detailed information, please review our{" "}
            <NewTabLink href="/help/privacy" className="text-accent-main hover:underline">Privacy Policy</NewTabLink> and{" "}
            <NewTabLink href="/kvkk" className="text-accent-main hover:underline">Data Protection Disclosure Text</NewTabLink>.
          </p>
        </section>
