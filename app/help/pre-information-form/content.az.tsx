      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>
              <strong>Yazı İrəli Çəkmə (Boost):</strong> İstifadəçilərin yazılarını ödənişli şəkildə irəli
              çəkməsinə imkan verən reklam xidmətidir. Gündəlik 100-1.500 TL büdcə ilə ən çox 7 gün müddətinə
              kampaniya yaradıla bilər.
            </li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li><strong>Ödəniş infrastrukturu:</strong> PCI-DSS uyğun təhlükəsiz ödəniş infrastrukturu</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Boost kampaniyaları hələ başlamamışdırsa tam geri ödəmə edilə bilər. Başlamış və ya tamamlanmış kampaniyalar üçün geri ödəmə edilmir.</li>
        ...
        <section>
          ...
          <p>
            ...
            <NewTabLink href="/help/privacy" className="text-accent-main hover:underline">Məxfilik Siyasətimizi</NewTabLink> və{" "}
            <NewTabLink href="/kvkk" className="text-accent-main hover:underline">KVKK Aydınlatma Mətnimizi</NewTabLink>{" "}
