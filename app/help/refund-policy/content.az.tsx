      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Təsdiqlənmiş geri ödəmələr təhlükəsiz ödəniş altyapısı vasitəsilə işlənərək ödəniş edilən karta qaytarılır.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>İllik premium abunəliklər abunəlik dövrü başladıqdan sonra geri ödənilmir. İstifadə olunmamış müddət üçün qismən geri ödəmə edilmir.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-bold text-text-primary mb-3">3. Boost Kampaniyaları</h2>
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            <li>Boost kampaniyaları ödənişli reklam xidməti xarakterindədir.</li>
            <li>
              <strong>Hələ başlamamış kampaniyalar:</strong> Kampaniya başlama tarixindən əvvəl ləğv edilərsə
              tam geri ödəmə edilir.
            </li>
            <li>
              <strong>Başlamış və ya tamamlanmış kampaniyalar:</strong> Aktiv olan və ya müddəti bitmiş
              kampaniyalar üçün geri ödəmə edilmir.
            </li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-bold text-text-primary mb-3">4. Geri Ödəmə Prosesi</h2>
          ...
          <p className="mt-3 text-xs text-text-muted">Geri ödəmə tələbləri təhlükəsiz ödəniş altyapımız vasitəsilə işlənir.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-text-primary mb-3">5. Pul Geri Ödəməsi</h2>
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            <li>Texniki xəta və ya təkrarlanan ödəniş kimi hallarda tam geri ödəmə edilir.</li>
            <li>Geri ödəmə ödəniş altyapısı tərəfindən işlənir və ödəniş edilən karta ortalama 5-10 iş günü ərzində əks olunur.</li>
            <li>Bankınızın əməliyyat müddətindən asılı olaraq bu müddət uzana bilər.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-bold text-text-primary mb-3">6. Ləğv Hüququ</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-text-primary mb-3">7. Əlaqə</h2>
          <p>
