...
export const metadata: Metadata = {
  title: "İade ve İptal Politikası - Feedim",
  description: "Feedim iade ve iptal politikası. Jeton ve premium üyelik iade koşulları, süreçleri ve haklarınız.",
  keywords: ["iade politikası", "iptal politikası", "feedim iade", "cayma hakkı", "para iadesi"],
};
