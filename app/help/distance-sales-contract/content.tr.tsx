      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>
              <strong>Gönderi Öne Çıkarma (Boost):</strong> Kullanıcıların gönderilerini ücretli olarak öne çıkarmasını
              sağlayan reklam hizmetidir. Günlük 100-1.500 TL bütçe ile en fazla 7 gün süreyle kampanya oluşturulabilir.
            </li>
          </ul>
          <p className="mt-3">
            Tüm fiyatlar KDV (%20) dahildir. Güncel fiyat bilgileri satın alma sayfasında belirtilir.
            Ödeme yöntemi: Kredi/banka kartı ile 3D Secure güvenlikli ödeme (güvenli ödeme altyapısı).
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>
              <strong>Boost kampanyaları:</strong> Henüz başlamamış kampanyalar için tam iade yapılabilir.
              Başlamış veya tamamlanmış kampanyalar için iade yapılmaz.
            </li>
          </ul>
          <p className="mt-3">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 mt-3 text-sm text-text-secondary">
            ...
            <li>Ödeme işlemi güvenli ödeme altyapısı üzerinden yapılır. Kart bilgileri Feedim tarafından saklanmaz.</li>
