    ...
    <>
      ...
      <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
        <p>
          ...
          Məzmunlarınızın oxunması və digər istifadəçilərdən hədiyyə almaq yolu ilə jeton qazanırsınız və bu jetonları real pula çevirə bilərsiniz.
        </p>
        ...
        <p>
          Bu şərtləri ödəyən və müraciəti təsdiqlənən istifadəçilər avtomatik olaraq qazanc əldə etməyə başlayır.
        </p>

        {/* ── Qazanc Mənbələri ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Qazanc Mənbələri</h2>
        <p>
          Feedim-də bir neçə qazanc mənbəyi mövcuddur: <strong>Premium oxucuların</strong> məzmunlarınızı oxuması
          və digər istifadəçilərdən hədiyyə almaq.
          Premium üzvlüyə sahib oxucuların həyata keçirdiyi premium oxumalar jeton qazancı olaraq sayılır.
        </p>
        ...
        <p>
          ...
          Həmçinin digər istifadəçilərin göndərdiyi hədiyyələrdən də jeton qazanırsınız.
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Premium oxuma sayıları və nisbətləri</li>
        </ul>

        {/* ── Pul Çəkmə ── */}
        <h2 className="text-lg font-bold text-text-primary mt-8 mb-4">Pul Çəkmə</h2>
        <p>
          Qazandığınız jetonları nağd olaraq çəkə bilərsiniz. Çəkim şərtləri, IBAN təyinatı və
          əməliyyat müddətləri haqqında ətraflı məlumat üçün{" "}
          <NewTabLink href="/help/coins" className="text-accent-main hover:opacity-80 font-semibold">Jeton və Balans Sistemi</NewTabLink> səhifəsinə
          baxa bilərsiniz.
        </p>
