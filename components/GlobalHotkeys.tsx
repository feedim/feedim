...
export default function GlobalHotkeys() {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      const vpBar = document.querySelector(".vp-bar");
      const vpRect = vpBar ? (vpBar as HTMLElement).getBoundingClientRect() : null;
      const hasVideoPlayer = !!vpRect && vpRect.width > 0 && vpRect.height > 0;
      ...
      // Shift+/ (?) → open shortcuts modal (check BEFORE search to avoid conflict)
