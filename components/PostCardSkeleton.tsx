...
const article = "pt-[4px] pb-[5px] px-[3px] sm:px-2 mx-[7px] sm:mx-3 rounded-[24px] overflow-hidden";
    ...
    <article className={article}>
      <div className="flex gap-2 items-stretch">
        <div className="shrink-0 w-[42px] pt-[3px] flex flex-col items-center">
          <div className={`h-[42px] w-[42px] rounded-full bg-bg-secondary ${pulse}`} />
        </div>
        <div className="flex-1 min-w-0 flex flex-col p-[5px]">
          ...
          <div className={`mt-3 rounded-[12px] sm:rounded-[21px] w-full aspect-[4/3] sm:aspect-[3/2] bg-bg-secondary ${pulse}`} />
        </div>
      </div>
    </article>
  );
    ...
    <article className={article}>
      <div className="flex gap-2 items-stretch">
        ...
        <div className="flex-1 min-w-0 flex flex-col p-[5px]">
          ...
          <div className={`mt-3 rounded-[12px] sm:rounded-[21px] w-full min-h-[180px] sm:min-h-[160px] aspect-[3/4] sm:aspect-video bg-bg-secondary ${pulse}`} />
        </div>
      </div>
    </article>
  );
...
function VideoGridItemSkeleton() {
  return (
    <div>
      <div className={`w-full aspect-video min-h-[120px] bg-bg-secondary rounded-xl ${pulse} mb-3`} />
      <div className="flex gap-2.5">
        <div className={`h-10 w-10 rounded-full bg-bg-secondary ${pulse} shrink-0`} />
