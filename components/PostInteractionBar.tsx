    ...
    return (
      <>
        ...
        <div className="flex items-center gap-1 select-none">
          {noLike ? (
            <Link href={postUrl} className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl text-[0.82rem] font-semibold text-text-muted hover:text-accent-main transition">
