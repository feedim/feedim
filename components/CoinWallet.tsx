...
export function CoinWallet() {
  ...
  return (
    <Link href="/coins" aria-label={t("tokenBalance", { balance: balance.toLocaleString(locale) })}>
      <div className="flex items-center gap-2 px-3 py-2 bg-bg-secondary hover:bg-bg-tertiary rounded-xl transition-all cursor-pointer group">
        ...
        <div className="flex items-baseline gap-1">
          <span className="font-bold text-accent-main">{balance.toLocaleString(locale)}</span>
