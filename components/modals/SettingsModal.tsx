...
export default function SettingsModal({ open, onClose }: SettingsModalProps) {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      const profileData = data as SettingsProfile | null;
      if (profileData) {
        setProfile(profileData);
        setEmailVerified(Boolean(profileData.email_verified));
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        const data = (await res.json()) as DeleteAccountErrorResponse;
      ...
      const message = error instanceof Error ? error.message : t("accountDeleteFailed");
  ...
  const displayName = profile?.full_name || profile?.name || profile?.username || tc("user");
          ...
          <>
            ...
            >
              <div>
                ...
                <p className="text-2xl font-bold">
                  {profile?.coin_balance?.toLocaleString(locale) || 0}{" "}
            ...
            <div className="overflow-hidden">
              ...
              <div className="">
                ...
                <NewTabLink href="/help/contact" onClick={onClose} className="flex items-center justify-between px-4 py-3.5 hover:bg-bg-tertiary transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <NewTabLink href="/help/terms" onClick={onClose} className="flex items-center justify-between px-4 py-3.5 hover:bg-bg-tertiary transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <NewTabLink href="/help/privacy" onClick={onClose} className="flex items-center justify-between px-4 py-3.5 hover:bg-bg-tertiary transition-colors">
                  <div className="flex items-center gap-3">
              ...
              {!showDeleteConfirm ? (
                ...
                <div className="space-y-3 text-left">
                  ...
                  <div className="flex gap-2">
                    <button onClick={handleDeleteAccount} className="flex-1 t-btn accept relative !bg-error !text-white" disabled={confirmDeleteText !== "DELETE" || deleting} aria-label={t("deleteAccount")}>
