    ...
    >
      <div className="flex flex-col items-center py-4 px-4">
        ...
        <div data-modal-no-drag className="flex items-center gap-3 mt-4 w-full max-w-[280px]">
          ...
          <div className="flex-1 relative h-1.5 rounded-full bg-border-primary">
            <div
              className="absolute inset-y-0 left-0 rounded-full bg-accent-main"
              style={{ width: `${((scale - 1) / (maxScale - 1)) * 100}%` }}
            />
            <input
              type="range"
              min={1}
              ...
              className="absolute inset-0 w-full appearance-none bg-transparent outline-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-accent-main [&::-webkit-slider-thumb]:cursor-pointer"
            />
          </div>
          <button
            onClick={() => handleZoom(0.2)}
