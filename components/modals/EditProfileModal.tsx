...
import { Briefcase, ChevronRight, Phone, Link as LinkIcon } from "lucide-react";
          ...
          <>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <p className="text-[1.3rem] font-bold">{username || tc("user")}</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                {!usernameLockedUntil && username !== originalUsername && (
                    ...
                    <>
                      ...
                      <label className="text-xs text-text-muted mb-1">{t("contactEmail")}</label>
                        <input
                          ...
                          placeholder={tProfile("placeholderEmail")}
                        />
                      </div>
                      <div>
