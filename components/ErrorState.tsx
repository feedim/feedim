...
export default function ErrorState({
  ...
  return (
    <div
      className={`${style.bg} ${style.border} border rounded-xl p-8 text-center max-w-md mx-auto select-none`}
      role="alert"
      aria-live="polite"
    >
...
export function LoadingState({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 select-none" role="status" aria-live="polite">
...
export function EmptyState({
  ...
  return (
    <div className="text-center p-8 sm:p-12 select-none" role="status">
      {Icon && (
